<h2><a href="https://www.geeksforgeeks.org/problems/consonants-and-vowels-check-java/1?utm_source=chatgpt.com">Check Consonants and Vowels</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p dir="ltr"><span style="font-size: 18px;">You are given a string <strong>s,</strong> containing only lowercase letters. Count the number of vowels and the number of consonants. </span></p>
<ul dir="ltr">
...
<pre><span style="font-size: 18px;"><strong>Input: </strong>s = thequickbrownfoxjumpsoverthelazydog
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ |s| ≤ 100<br>Where, |s| is the size of string.</span></p></div><br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Java-Strings</code>&nbsp;<code>CPP</code>&nbsp;<code>python-loops</code>&nbsp;